document.addEventListener("DOMContentLoaded", function () {
    const wentWrongSections = document.querySelectorAll(".wentwrong-section1");
      ...
      if (wentWrongSection) {
        wentWrongSection.innerHTML = `
          <section class="pinned wentwrong-pinned-${sectionIndex}">
            ...
            <div class="card1" id="card-1-${sectionIndex}">
              <div class="card-phase"><p>#itdidwork1</p></div>
            ...
            <div class="card1" id="card-2-${sectionIndex}">
              <div class="card-phase"><p>#itdidwork2</p></div>
              <div class="card-title">
                <p>Pointer Controls</p>
                <h1>Cursor Based animations</h1>
              </div>
            </div>
            <div class="card1" id="card-3-${sectionIndex}">
              <div class="card-phase"><p>#itdidwork3</p></div>
              <div class="card-title">
                <p>Integration</p>
                <h1>iFrame+Three.js</h1>
              </div>
            </div>
          </section>
        `;
        ...
        style.innerHTML = `
          ...
          * {
          ...
          #card-1-${sectionIndex} {
            background: url(./public/wentwrong/assets/card-1.png) no-repeat 50% 50%;
          }
          
          #card-2-${sectionIndex} {
            background: url(./public/wentwrong/assets/card-2.png) no-repeat 50% 50%;
          }
          
          #card-3-${sectionIndex} {
            background: url(./public/wentwrong/assets/card-3.png) no-repeat 50% 50%;
          }
